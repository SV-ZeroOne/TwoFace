                            ...
                            <c:when test="${shoppingCart != null}">
                                ...
                                <table class='table col-xs-12'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><img src="${cartitem.stock.issue.imageRef}" onerror="this.src = 'http://pre10.deviantart.net/23f7/th/pre/i/2015/327/0/d/star_wars_vintage_tfa_comic_cover_issue1_by_daztibbles-d9hq35o.png';" class='img-responsive' height="50" width="50"/>
                                            </td>
